...
elec_df      = elec_df[elec_df['Electrode_type'] == 'Microelectrode']
...
output_path = '../outputs/'
plt.savefig(output_path + 'Figure4_micro.svg', format='svg', dpi=600)
plt.savefig(output_path + 'Figure4_micro.png', format='png', dpi=600)
