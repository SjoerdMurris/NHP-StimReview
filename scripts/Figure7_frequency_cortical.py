...
data_label = 'cortical' # Specify cortical or subcortical to plot
...
cort_miss_labels = ['TG','ParaHipp','V6/V6A','SII','MCC']
...
ax2.bar(singular_frequency_count.keys(), range_frequency_count, color=range_frequency_colour, edgecolor='none', width=10, alpha=1, zorder=1)
...
output_path = '../outputs/'
plt.savefig(output_path + 'Figure7_Cortical.svg', format='svg', dpi=600)
plt.savefig(output_path + 'Figure7_Cortical.png', format='png', dpi=600)
