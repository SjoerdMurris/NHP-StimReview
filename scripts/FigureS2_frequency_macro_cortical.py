...
cort_miss_labels = ['V4','MT','STG/STS','TG','PCC','Area 7','MST','latIPS','vmIPS','Area 5','V6/V6A','vlPFC','MCC']
...
ax2.bar(singular_frequency_count.keys(), range_frequency_count, color='indianred', edgecolor='none', width=10, zorder=1)
...
output_path = '../outputs/'
plt.savefig(output_path + 'FigureSupp2.svg', format='svg', dpi=600)
plt.savefig(output_path + 'FigureSupp2.png', format='png', dpi=600)
